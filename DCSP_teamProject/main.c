...
void main(void)
{
    ...
    DAQmxCreateAIVoltageChan(taskAI, "Dev8/ai2, Dev8/ai3", "",
        DAQmx_Val_RSE, -10.0, 10.0, DAQmx_Val_Volts, "");
    DAQmxCreateAOVoltageChan(taskAO0, "Dev8/ao0", "", 0.0, 5.0, DAQmx_Val_Volts, "");
    DAQmxCreateAOVoltageChan(taskAO1, "Dev8/ao1", "", 0.0, 5.0, DAQmx_Val_Volts, "");
